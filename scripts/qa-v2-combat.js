...
const aim=p=>({x:p.x,y:p.y+.3-35.8,z:p.z});
...
p=stage(s.bots[1],.006);s.cooldown=0;s.fireMarksman({x:p.x,y:p.y+1.3-35.8,z:p.z});result.helmetHit=s.bots[1].health;s.recover();result.recoverIgnored=s.phase==='racing';
