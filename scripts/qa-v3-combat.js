...
p=stage(s.bots[1],.006);s.cooldown=0;s.fireMarksman({x:p.x,y:p.y+1.3-s.markEye().y,z:p.z});result.helmetHit=s.bots[1].health;s.recover();result.recoverIgnored=s.phase==='racing';
