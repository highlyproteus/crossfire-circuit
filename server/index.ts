...
app.get('/health',(_req,res)=>res.json({ok:true,game:'crossfire-circuit',version:'public-launch-1',rooms:ArenaRoom.active.size,players:[...ArenaRoom.active].reduce((n,r)=>n+r.players.size,0)}));
...
installAdmission(transport.server!,{trustCloudflare:process.env.TRUST_CLOUDFLARE==='true'});
